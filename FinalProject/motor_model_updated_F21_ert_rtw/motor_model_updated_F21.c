...
void motor_model_updated_F21_step(void)
{
...

  {
     ...
     *  Gain: '<S2>/angular_position =  [relative_count//COUNTS_PER_REV] *360 degrees'
     */
    tmp_2 = &motor_model_updated_F21_B.angular_positionrelative_countC;

    /* Sum: '<Root>/Sum1' */
    motor_model_updated_F21_B.ErrorSignal = motor_model_updated_F21_B.Setpoint -
      sMultiWord2Double(&tmp_2->chunks[0U], 2, 0) * 1.4551915228366852E-11;

    /* Derivative: '<S1>/Derivative1' */
    motor_model_updated_F21_B.Abs = motor_model_updated_F21_M->Timing.t[0];
    if ((motor_model_updated_F21_DW.TimeStampA >= motor_model_updated_F21_B.Abs)
        && (motor_model_updated_F21_DW.TimeStampB >=
            motor_model_updated_F21_B.Abs)) {
      motor_model_updated_F21_B.Abs = 0.0;
    } else {
      ...
      if (motor_model_updated_F21_DW.TimeStampA <
          motor_model_updated_F21_DW.TimeStampB) {
        if (motor_model_updated_F21_DW.TimeStampB <
            motor_model_updated_F21_B.Abs) {
      ...
      motor_model_updated_F21_B.Abs = (motor_model_updated_F21_B.ErrorSignal -
        *lastU) / (motor_model_updated_F21_B.Abs - rtb_Abs1);
    }
     ...
     */
    motor_model_updated_F21_B.Abs = (motor_model_updated_F21_P.Kp_Gain *
      motor_model_updated_F21_B.ErrorSignal + motor_model_updated_F21_P.Kd_Gain *
      motor_model_updated_F21_B.Abs) + motor_model_updated_F21_P.Ki_Gain *
      motor_model_updated_F21_X.Integrator1_CSTATE;

    /* Saturate: '<S2>/Saturation' */
    if (motor_model_updated_F21_B.Abs >
        motor_model_updated_F21_P.Saturation_UpperSat) {
      motor_model_updated_F21_B.Abs =
        motor_model_updated_F21_P.Saturation_UpperSat;
    } else if (motor_model_updated_F21_B.Abs <
               motor_model_updated_F21_P.Saturation_LowerSat) {
      motor_model_updated_F21_B.Abs =
        motor_model_updated_F21_P.Saturation_LowerSat;
    }
    ...
    if (rtmIsMajorTimeStep(motor_model_updated_F21_M)) {
      if ((motor_model_updated_F21_B.Abs > 0.0) && (rtb_Abs1 > 3.0)) {
        motor_model_updated_F21_DW.ChooseDirection_ActiveSubsystem = 0;
      } else if ((motor_model_updated_F21_B.Abs < 0.0) && (rtb_Abs1 > 3.0)) {
     ...
     *  Abs: '<S2>/Abs'
     */
    motor_model_updated_F21_B.Abs = motor_model_updated_F21_P.Gain_Gain * fabs
      (motor_model_updated_F21_B.Abs);

    /* MATLABSystem: '<S2>/Enable' */
    if (!(motor_model_updated_F21_B.Abs <= 255.0)) {
      motor_model_updated_F21_B.Abs = 255.0;
    }
    ...
    MW_PWM_SetDutyCycle
      (motor_model_updated_F21_DW.obj_b.PWMDriverObj.MW_PWM_HANDLE,
       motor_model_updated_F21_B.Abs);
    if (rtmIsMajorTimeStep(motor_model_updated_F21_M)) {
      /* MATLABSystem: '<S2>/Driver In1' */
      motor_model_updated_F21_B.Abs = rt_roundd_snf(rtb_Merge1);
      ...
      motor_model_updated_F21_B.Abs = rt_roundd_snf(rtb_Merge2);
      if (motor_model_updated_F21_B.Abs < 256.0) {
        if (motor_model_updated_F21_B.Abs >= 0.0) {
          tmp_1 = (uint8_T)motor_model_updated_F21_B.Abs;
        } else {
    ...
    *lastU = motor_model_updated_F21_B.ErrorSignal;
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      ...
      extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
        (((motor_model_updated_F21_M->Timing.clockTick0+
           motor_model_updated_F21_M->Timing.clockTickH0* 4294967296.0) * 1) + 0)
        ;
    ...
    if (rtmIsMajorTimeStep(motor_model_updated_F21_M)) {/* Sample time: [0.001s, 0.0s] */
      extmodeErrorCode_T errorCode = EXTMODE_SUCCESS;
      extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
        (((motor_model_updated_F21_M->Timing.clockTick1+
           motor_model_updated_F21_M->Timing.clockTickH1* 4294967296.0) * 1) + 0)
        ;
...
void motor_model_updated_F21_initialize(void)
{
  ...
  rtmSetTFinal(motor_model_updated_F21_M, -1);
...

  {
    ...
    rteiSetChecksumsPtr(motor_model_updated_F21_M->extModeInfo,
                        motor_model_updated_F21_M->Sizes.checksums);
    rteiSetTPtr(motor_model_updated_F21_M->extModeInfo, rtmGetTPtr
                (motor_model_updated_F21_M));
  }
