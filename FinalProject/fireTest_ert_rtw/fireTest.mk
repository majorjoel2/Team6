###########################################################################
## Makefile generated for component 'fireTest'. 
## 
## Makefile     : fireTest.mk
## Generated on : Sun Apr 17 18:06:10 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fireTest.elf
...
PRODUCT_NAME              = fireTest
MAKEFILE                  = fireTest.mk
MATLAB_ROOT               = D:/Program Files/MATLAB/R2021b
MATLAB_BIN                = D:/Program Files/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/ClemsonNotes/Design1/Team6/FinalProject
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/tanne/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fireTest.elf
...
DEFINES_STANDARD = -DMODEL=fireTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o fireTest.o fireTest_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/fireTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/fireTest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/fireTest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/fireTest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fireTest.o : $(START_DIR)/fireTest_ert_rtw/fireTest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fireTest_data.o : $(START_DIR)/fireTest_ert_rtw/fireTest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
